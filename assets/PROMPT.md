...
Scene/backdrop: genuinely transparent background, actual alpha channel, all surrounding space fully transparent.
Constraints: no text, letters, numbers, logos, watermark, balls, extra objects, enclosing background tile, frame around the icon, drop shadow beyond the silhouette, checkerboard, or opaque backdrop.
